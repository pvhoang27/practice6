...
//[Mã câu hỏi (qCode): E6dWHrYX].  Một dịch vụ web (hỗ trợ SOAP version 1.1) được định nghĩa và mô tả trong tệp ObjectService.wsdl, được triển khai trên server tại URL http://<Exam_IP>:8080/JNPWS/ObjectService?wsdl để xử lý các bài toán với đối tượng.
...
public class LocSvTheoDiem {
    public static void main(String[] args) throws Exception{
        String studentCode = "B17DCCN043",qCode = "E6dWHrYX";
        ...
        for(Student x : a ){
            ...
            if(score >= 8.0f || score < 5.0f) kq.add(x);
        }
